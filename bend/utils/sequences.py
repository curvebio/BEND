...
label_dict = {
    "labels_simple_direction_DA": {
        "+": {
            ...
            "end_intron": 3,
            "CDS": np.array([0]),
            "start_codon": 0,  # exon label
            "three_prime_UTR": 8,
            "five_prime_UTR": 8,
            "stop_codon": 8,
            "stop_codon_redefined_as_selenocysteine": 8,  # non_coding
        },
        "-": {
            "exon": 8,
            "start_intron": 7,
            ...
            "end_intron": 5,
            "CDS": np.array([4]),
            "start_codon": 4,  # exon label
            "three_prime_UTR": 8,
            "five_prime_UTR": 8,
            "stop_codon": 8,
            "stop_codon_redefined_as_selenocysteine": 8,
        },
        "non_coding": 8,
        "padding": 8,
    },
    "labels_codon_direction_DA": {
        "+": {
            ...
            "five_prime_UTR": 24,
            "stop_codon": 24,
            "stop_codon_redefined_as_selenocysteine": 24,  # non_coding
        },
        "-": {
            "exon": 24,
            "start_intron": 21,
            ...
            "five_prime_UTR": 24,
            "stop_codon": 24,
            "stop_codon_redefined_as_selenocysteine": 24,
        },
        "non_coding": 24,
        "padding": 24,
    },
    ...
    "labels_codon_utr_direction_DA": {
        "+": {
            ...
            "three_prime_UTR": 13,
            "stop_codon": 13,
            "stop_codon_redefined_as_selenocysteine": 13,  # non_coding
        },
        "-": {
            "five_prime_UTR": 14,
            "exon": 28,
            ...
            "three_prime_UTR": 27,
            "stop_codon": 27,
            "stop_codon_redefined_as_selenocysteine": 27,
        },
        "non_coding": 28,
        "padding": 28,
    },
